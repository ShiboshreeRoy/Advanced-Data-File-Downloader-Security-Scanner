...
SENSITIVE_FILES = [".env", "config.json", "database.sql", "backup.zip", ".git/config", ".htaccess", "robots.txt"]
...
def print_banner():
 ...
 |_____/ \__,_|\__,_|_|  \__,_| |_____/ \___|_|    \_/ \___|_|  |___/\___|
          ...
          Security Scanner v:0.0 - Data & File Downloader
""" + RESET)
...
def download_additional_files(url):
    """Download additional necessary files like homepage and sitemap if available."""
    ...
    # Attempt to download sitemap.xml
...
def print_banner():
 ...
 |_____/ \__,_|\__,_|_|  \__,_| |_____/ \___|_|    \_/ \___|_|  |___/\___|
          ...
          Security Scanner v2.0 - Data & File Downloader
""" + RESET)
